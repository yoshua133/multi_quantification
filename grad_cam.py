...
if __name__ == '__main__':
    ...
    model = torchvision.models.resnext101_32x8d(pretrained=False, num_classes = num_of_need_attri)
    # model = resnet.resnet101(pretrained=False, num_classes = num_of_need_attri)
    
    model.eval()
    load_model_path = os.path.join(save_dir, '20230325_093303part1attri_8_12resnext101_32x8d_101_1','model_param.pkl')
    if load_model_path:
        ckpt = torch.load(load_model_path, map_location=torch.device('cpu'))
    ...
    num_id = '015'
    image_path = "E:/ai_images_1_1036(important)/001/cropped_image_a001, 22Maxilla, Application.tif"
    output_path = "./data/visual/"
