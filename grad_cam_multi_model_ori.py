...
if __name__ == '__main__':
    ...
    start_patient_id = 1  #开始画可视化图的病人编号
    end_patient_id = 1035    #结束的标号
    model_pkl_name = "20220808_114832part1attri_4_12resnext50_32x4d_201_1"  #在train_file下找到需要可视化的模型的文件名，黏贴过来,需要跟路径中间的模型名称完全一样
